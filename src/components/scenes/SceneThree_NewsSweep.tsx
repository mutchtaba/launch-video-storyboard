        ...
        <div className="flex flex-col items-start gap-5 shrink-0">
          ...
          <div className="w-[480px] space-y-3">
            ...
            <div className="space-y-2">
              {/* Bloomberg */}
              <div className="flex items-center gap-3 py-2.5 px-3.5 rounded-xl" style={{ background: 'rgba(10,10,15,0.9)', backdropFilter: 'blur(20px)', border: '1px solid rgba(255,255,255,0.06)' }}>
          ...
          <div className="border border-dashed border-zinc-300 rounded-lg p-2.5 w-[480px]">
            <p className="text-zinc-500 text-[10px] font-mono leading-relaxed">
              ...
              Voiceover reads the streamed text aloud.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col items-start gap-5 shrink-0">
          ...
          <div
            ...
            style={{
              ...
              boxShadow: '0 0 40px rgba(16,185,129,0.08), 0 8px 32px rgba(0,0,0,0.3)',
          ...
          <div className="border border-dashed border-zinc-300 rounded-lg p-2.5 w-[480px]">
            <p className="text-zinc-500 text-[10px] font-mono leading-relaxed">
              ...
              dashboard cards. Findings text streams in below. Sentiment bar fills, sector columns 
              slide in. Voiceover reads the findings aloud.
            </p>
          </div>
        </div>
